...
airlines_dom <- read.csv("C:/Users/Gany/Desktop/Airfare Project/FinalDomesticDataset.csv")
str(airlines_dom)
...
airlines_international <- read.csv("C:/Users/Gany/Desktop/Airfare Project/FinalInternationalDataset.csv")
